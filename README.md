...
Все модели демонстрируют схожее качество предсказаний с **ROC-AUC 0.86-0.87**, что указывает на хорошую способность ранжировать заемщиков по уровню риска.
...
- **Градиентные бустинги** показали лишь незначительное преимущество перед логистической регрессией
- **Рекомендация**: логистическая регрессия с WoE как основная production-модель в силу наилучшей интерпретируемости и сравнительного качества
...
Реализован модульный pipeline предобработки с конфигурируемыми компонентами:
...
Подробнее см. [ноутбук с Feature Engineering](notebooks/2.0-feature-engineering.ipynb).

### 3. Modeling

#### Baseline
Логистическая регрессия с минимальной предобработкой (клиппинг + масштабирование)

#### Tuned Logistic Regression
- Полная цепочка feature engineering
