...
Сформировано пространство признаков и обучен ряд моделей. На обработанных данных все модели демонстрируют схожее качество предсказаний с **ROC-AUC 0.86-0.87**, что указывает на хорошую способность ранжировать заемщиков по уровню риска.
